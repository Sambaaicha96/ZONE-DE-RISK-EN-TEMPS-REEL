...
console.log(map);
var quartiers = [
    { nom: 'Koloma', coordonnees: [9.5947835, -13.6245924] , info: 'koloma danger' },
    { nom: 'Hamdallaye', coordonnees: [9.5726627, -13.6571109]  , info: 'hamd danger'},
    { nom: 'Kaporo', coordonnees: [9.6139260, -13.6452606]  , info: 'kaporo danger'},
    { nom: 'Lambagni', coordonnees: [9.6371911, -13.6104834]  , info: 'Lambangny danger'},
    { nom: 'Wanindara', coordonnees: [9.6322693, -13.5899211]  , info: 'wanindra danger'},
    { nom: 'Kobaya', coordonnees: [9.6573188, -13.5982644]  , info: 'kobaya danger'}
];

quartiers.forEach(function (quartier) {
    var marker = L.marker(quartier.coordonnees).addTo(map);
    marker.bindPopup("<div>" + '<h4>' +quartier.nom + "</h4><p class='alert alert-success'>"+quartier.info+'</p>' +"</div>").openPopup();
});
